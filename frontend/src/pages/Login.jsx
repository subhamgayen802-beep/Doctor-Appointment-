    ...
    <div className="min-h-screen flex bg-[#F8F9FB] font-sans">
      ...
      <div className="w-full lg:w-[55%] xl:w-1/2 flex items-center justify-center p-6 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <h2 className="text-2xl font-semibold text-center text-gray-800 mb-8">Hello ! Welcome back</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-between mb-6">
              <label className="flex items-center text-sm text-gray-600 cursor-pointer select-none">
                <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#4F46E5] focus:ring-[#4F46E5] mr-2" />
                Remember me
              </label>
              <NavLink to="/forgot-password" className="text-sm text-[#4F46E5] hover:text-[#4338CA] font-medium">
                Reset Password!
              </NavLink>
            </div>
          ...
          <p className="text-center text-sm text-gray-600">
            ...
            <NavLink to="/signup" className="text-[#4F46E5] hover:text-[#4338CA] font-semibold">
              Sign Up
            </NavLink>
          </p>
        </div>
